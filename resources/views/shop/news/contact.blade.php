    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
	    				<h2 class="title text-center">Gửi thông tin </h2>
	    				<div class="status alert alert-success" style="display: none"></div>
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post">
				    		{{csrf_field()}}				    		
				    		<div class="form-group col-md-6">
				    			<input type="text" name="fullname" class="form-control" required="required" placeholder="Nhập họ tên"
				    			id="fullname">
				    		</div>
				            <div class="form-group col-md-6">
				            ...
				            <div class="form-group col-md-12">
				            	<a href="javascript:void()" title="" class="btn btn-primary pull-right btn-lg" id="send">Gửi</a>
				            </div>
				        </form>
	    			</div>
	    		</div>
