...
<!-- jQuery UI 1.11.4 -->
<script src="{{getenv('ADMIN_TEMPLATE_URL')}}/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- daterangepicker -->
<script src="{{getenv('ADMIN_TEMPLATE_URL')}}/bower_components/moment/min/moment.min.js"></script>
...
<script src="{{getenv('ADMIN_TEMPLATE_URL')}}/dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{getenv('ADMIN_TEMPLATE_URL')}}/dist/js/demo.js"></script>
<!-- DataTables -->
