...
<head>
  ...
  <!-- AdminLTE Skins. Choose a skin from the css/skins
   ...
   <!-- jvectormap -->
   <link rel="stylesheet" href="{{getenv('ADMIN_TEMPLATE_URL')}}/bower_components/jvectormap/jquery-jvectormap.css">
   <!-- Date Picker -->
   ...
   <link rel="stylesheet" href="{{getenv('ADMIN_TEMPLATE_URL')}}/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
   <!-- DataTables -->
   <link rel="stylesheet" href="{{getenv('ADMIN_TEMPLATE_URL')}}/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
   <link rel="stylesheet" href="{{getenv('ADMIN_TEMPLATE_URL')}}/bower_components/Croppie/croppie.css">
